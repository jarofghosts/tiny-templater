var template = require('../index.js'),
    ...
    view3 = '{{ greeting }}, {{ person.name }} or "{{ person.nicknames.favorite }}": how is your {{ week.day }}?',
    data2 = { greeting: 'hey', person: { name: 'Robert', nicknames: { favorite: 'Robbie' } }, week: { day: 'Friday' } },
    tpl = template(view),
    tpl2 = template(view2),
    tpl3 = template(view3);
